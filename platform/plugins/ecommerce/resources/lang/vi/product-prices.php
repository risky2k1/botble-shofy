...
return [
    'name' => 'Giá sản phẩm',
    'warning_prices' => 'Các mức giá này đại diện cho chi phí gốc của sản phẩm và có thể không phản ánh giá cuối cùng, có thể thay đổi do các yếu tố như flash sale, khuyến mãi và nhiều hơn nữa.',
    ...
    'import' => [
        ...
        'rules' => [
            ...
            'cost_per_item' => 'Trường giá vốn mỗi sản phẩm phải là giá trị số.',
