...
return [
    ...
    'statuses' => [
        ...
        'pending' => 'Đang chờ',
        'arrange_shipment' => 'Sắp xếp vận chuyển',
        'ready_to_be_shipped_out' => 'Sẵn sàng được giao',
    ...
    'shipment_canceled' => 'Vận chuyển đã bị hủy',
    'at' => 'Lúc',
    ...
    'history' => 'Lịch sử',
    'shipment_information' => 'Thông tin vận chuyển',
    ...
    'change_status_confirm_description' => 'Bạn có chắc chắn muốn xác nhận <span class="shipment-status-label"></span> cho đơn vận này?',
    'accept' => 'Chấp nhận',
    ...
    'shipment_id' => 'Mã vận chuyển',
    'not_available' => 'Không có sẵn',
    'shipping_amount' => 'Số tiền vận chuyển',
    'additional_shipment_information' => 'Thông tin bổ sung về đơn vận',
    ...
    'rule' => [
        ...
        'item' => [
            ...
            'confirmation' => 'Bạn có chắc chắn muốn xóa mục quy tắc vận chuyển <strong class="item-label"></strong>?',
            ...
            'tables' => [
                ...
                'city' => 'Thành phố',
                'zip_code' => 'Mã bưu điện',
                'adjustment_price' => 'Điều chỉnh giá',
                'is_enabled' => 'Đã bật?',
            ],
            'forms' => [
                'country' => 'Quốc gia',
                ...
                'adjustment_price' => 'Điều chỉnh giá',
                'adjustment_price_placeholder' => 'Điều chỉnh giá',
                'is_enabled' => 'Đã bật?',
                'no_shipping_rule' => 'Không có quy tắc vận chuyển',
                'adjustment_price_helper' => 'Để trừ từ giá, chỉ cần sử dụng số âm. VD: -10',
            ],
            'bulk-import' => [
                ...
                'between' => 'Chỉ chấp nhận số hoặc số thập phân và từ :min đến :max.',
                'overwrite' => 'Ghi đè',
                'add_new' => 'Thêm mới',
                'skip' => 'Bỏ qua',
            ],
    ...
    'empty_shipping_options' => [
        ...
        'subtitle' => 'Nhấp vào thêm quốc gia từ phía bên trái để thêm tùy chọn vận chuyển mới.',
    ],
    ...
    'shipping_based_on_zip_code_instruction' => 'Nếu bạn muốn đặt phí vận chuyển dựa trên mã bưu điện, bạn cần bật ":link_text" trong Cài đặt -> Thanh toán và đặt mã bưu điện cho địa chỉ cửa hàng.',
    'shipping_label' => [
        ...
        'scan_qr_code' => 'Quét mã QR để theo dõi đơn vận của bạn',
    ],
    'customer_confirmed_delivery_at' => 'Khách hàng xác nhận giao hàng lúc',
];
