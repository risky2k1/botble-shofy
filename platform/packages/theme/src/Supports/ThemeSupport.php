...
use Botble\Base\Forms\Fields\SelectField as BaseSelectField;
        ...
        shortcode()
            ->register(
                ...
                function (Shortcode $shortcode) use ($viewPath) {
                    ...
                    return view($viewPath . '.google-map', compact('address', 'width', 'height', 'shortcode'))
                        ->render();
                }
            )
            ...
            ->setAdminConfig('google-map', function (array $attributes, ?string $content) {
                return ShortcodeForm::createFromArray($attributes)
                    ...
                    ->add(
                        'display_style',
                        BaseSelectField::class,
                        SelectFieldOption::make()
                            ->label(__('Display Style'))
                            ->choices(['default' => __('Default'), 'full-width' => __('Full Width')])
                    )
                    ->add('width', NumberField::class, [
                        'label' => __('Width'),
                    ])
