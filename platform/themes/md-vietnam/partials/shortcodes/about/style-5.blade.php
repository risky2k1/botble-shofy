<section class="free-consultation tp-full-width">
    <div class="container">
        <div class="box-free-consultation">
            <div class="row">
                <div class="col-lg-5">
                    <div class="images-free-consultation">
                        @if ($shortcode->image_1)
                            {{ RvMedia::image($shortcode->image_1) }}
                        @endif
                ...
                <div class="col-lg-7">
                    <div class="content-desp-free-consultation">
                        @if ($shortcode->subtitle_2)
                            <h2>
                                {{ $shortcode->subtitle_2 }}
                            </h2>
                        @endif
                        @if ($shortcode->description_2)
                            {!! $shortcode->description_2 !!}
                        @endif

                        @if ($shortcode->action_label && $shortcode->action_url)
                            <div class="box-btn-free-consultation">
                                <a href="{{ $shortcode->action_url }}" target="_blank">
                                    <span class="btn-dangky-about1"><svg width="64px" height="64px"
                                        ...
                                        </svg> {{ $shortcode->action_label }}</span>
                                </a>
                            </div>
                        @endif
                    </div>
